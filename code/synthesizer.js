...
// var testTree = require("../test/integration/tree/basic_directive2.json");
...
// intCodeGen(testTree, testTree.scope);
...
function readAttribute(attributeToken) {
  return attributeToken.attribute + "=\"" + attributeToken.value + "\"";
}
...
function makeEvalable(conditionString) {
  ...
  if (variables == null) return conditionString;
